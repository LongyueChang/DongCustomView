...
public class PaceTableV3 extends View {
    ...
    public PaceTableV3(Context context) {
        this(context,null);
    }

    public PaceTableV3(Context context, AttributeSet attrs) {
        this(context, attrs,0);
    }

    public PaceTableV3(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void drawColumn(Canvas canvas) {
        ...
        for (int i = 0; i < 7; i++) {
            canvas.drawLine(2*textWidth+i* textWidth,mHeight-textHeight*13,
                    2*textWidth+i* textWidth,columnHeight.get(i)*(5000/(mHeight-textHeight*16)),columnbPaint);
        }
        canvas.restore();
    }
